...
static GdkColor focus={0,0x2121,0x9696,0xf3f3};
...
static GdkColor green = {0,0x9898,0xFBFB,0x9898};
static GdkColor yellow = {0,0xCDCD,0xCDCD,0xB4B4};
...
void fontSelect( GtkWidget *button, textView *textViewAll)
{
    ...
    GtkWidget *window;
    window = gtk_font_selection_dialog_new ("Rosetta 字体选择");
...
void on_main_button_clicked(GtkWidget* button,GdkEventButton *event,window_status* data){
    ...
    if(now_id!=aim_id){
        gtk_widget_modify_bg(GTK_WIDGET(button),GTK_STATE_NORMAL,&Blue);
...
void on_event_box_moved(GtkWidget* event_box,GdkEventCrossing *event,window_status* data){
    if(*(data->now_id)!=data->aim_id)
        gtk_widget_modify_bg(GTK_WIDGET(event_box),GTK_STATE_NORMAL,&Blue);
}
...
//================
	...
	gtk_widget_modify_bg(friend_list_box,GTK_STATE_NORMAL,&red);//改动位置
	gtk_widget_set_size_request(GTK_WIDGET(friend_list_box),300,300);
	group_list_box=sky_group.Mainbox;
	gtk_widget_modify_bg(group_list_box,GTK_STATE_NORMAL,&red);
    ...
    GtkWidget* SkyQ_title_label=gtk_label_new("Rosetta");
...
//==============================================================
    ...
    gtk_widget_show_all(MenuBar);//改动位置
...
//==================main_window======================================
    ...
    gtk_window_set_title(GTK_WINDOW(window),"Rosetta 1.0 beta");
    ...
    //gtk_window_set_title(GTK_WINDOW(window),"SkyQ");//改动位置
...
//=================================================================
    ...
    //gtk_label_set_markup(GTK_LABEL(ip_pos),"<span foreground='white'>昵称 </span>");
	...
	gtk_widget_modify_bg(cmeventbox1,GTK_STATE_NORMAL,&focus);


    cmlabel = gtk_label_new(NULL);
    gtk_label_set_markup(GTK_LABEL(cmlabel), "<span foreground=\"#000000\">111</span>");
    gtk_container_add(GTK_CONTAINER(cmeventbox1),cmlabel);
    ///Part2
    msg_box = gtk_hbox_new(FALSE,0);
    scwin1= gtk_scrolled_window_new(NULL,NULL);
    gtk_window_set_opacity(GTK_WINDOW(scwin1), 0.7);
    ...
    //gtk_widget_modify_bg(cmeventbox2,GTK_STATE_NORMAL,&yellow);
    //logo_label = gtk_label_new(NULL);
    //gtk_label_set_markup(GTK_LABEL(logo_label),"<span foreground=\"blue\"><big>Welcome to Rosetta</big></span>");
    ...
    gtk_box_pack_start(GTK_BOX(group_would),cmeventbox2,TRUE,TRUE,5);
    gtk_widget_set_size_request(cmeventbox2,180,20);
	...
	gtk_widget_modify_bg(cmeventbox3,GTK_STATE_NORMAL,&yellow);
    ...
    gtk_widget_modify_bg(button2,GTK_STATE_NORMAL,&white);
    gtk_widget_modify_bg(button2,GTK_STATE_PRELIGHT,&green);
    GtkWidget *labelChild2 = gtk_bin_get_child(GTK_WIDGET(button2));
    gtk_label_set_markup(GTK_LABEL(labelChild2), "<span foreground=\"#000000\">发送</span>");

    gtk_box_pack_start(GTK_BOX(button_box),button2,TRUE,TRUE,5);

    gtk_box_pack_start(GTK_BOX(send_box),scwin2,TRUE,TRUE,0);
    gtk_box_pack_start(GTK_BOX(send_box),button_box,FALSE,FALSE,0);
    gtk_widget_set_size_request (button_box, 180, 10);
    //part 5 聊天框上方文件传送
    ...
    gtk_widget_modify_bg(button1,GTK_STATE_NORMAL,&white);
    gtk_widget_modify_bg(button1,GTK_STATE_PRELIGHT,&green);
    gtk_label_set_markup(GTK_LABEL(labelChild1),"<span foreground=\"#000000\">表情</span>");
    ...
    gtk_widget_modify_bg(buttonFileTransform,GTK_STATE_NORMAL,&white);
    gtk_widget_modify_bg(buttonFileTransform,GTK_STATE_PRELIGHT,&green);
    gtk_label_set_markup(GTK_LABEL(labelChildFileTransform),"<span foreground=\"#000000\">文件传输</span>");
    ...
    gtk_widget_modify_bg(button_Font,GTK_STATE_NORMAL,&white);
    gtk_widget_modify_bg(button_Font,GTK_STATE_PRELIGHT,&green);
    gtk_label_set_markup(GTK_LABEL(labelChileButton_Font),"<span foreground=\"#000000\">修改字体</span>");
    ...
    gtk_widget_modify_bg(button_background,GTK_STATE_NORMAL,&white);
    gtk_widget_modify_bg(button_background,GTK_STATE_PRELIGHT,&green);
    gtk_label_set_markup(GTK_LABEL(labelChileButton_background),"<span foreground=\"#000000\">修改主题</span>");
...
//==========================welcome_page===================================
    init_welcome_label=gtk_label_new("Welcome to world of Rosetta!");
